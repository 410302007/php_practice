        ...
        <div class="card-body">
          ...
          <form name="form1" onsubmit="checkForm(event)" novalidate>
            ...
            <div class="mb-3">
              ...
              <span class="form-control" id="name" name="name"><?= $r['name'] ?></span>
              <div class="form-text"></div>
            </div>

            <div class="mb-3">
              <label for="email" class="form-label">信箱</label>
              <span class="form-control" id="email" name="email"><?= $r['email'] ?></span>
              <div class="form-text"></div>
            </div>

            <div class="mb-3">
              <label for="mobile" class="form-label">電話</label>
              <span class="form-control" id="mobile" name="mobile" pattern="09\d{2}?\d{3}?\d{3}"><?= $r['mobile'] ?></span>
              <div class="form-text"></div>
            </div>

            <div class="mb-3">
              <label for="birthday" class="form-label">生日</label>
              <span class="form-control" id="birthday" name="birthday"> <?= $r['birthday'] ?></span>
              <div class="form-text"></div>
            </div>
            ...
            <div class="mb-3">
              ...
              <!-- htmlentities => 把字轉換為html -->
              <span class="form-control" name="address" id="address" cols="30" rows="3"><?= htmlentities($r['address']) ?></span>
              <!-- <div class="form-text"></div> -->
            </div>
            ...
            <input type="button" class="btn btn-primary" onclick="history.back();" value="返回上一頁">
